          ...
          {showDeleted && (
              <div className="mt-3">
                {deletedLoading ? (
                    ...
                    <p className="text-xs text-gray-600 py-4">No deleted users.</p>
                ) : (
                    <div className="bg-gray-900/50 border border-gray-800/50 rounded-xl overflow-hidden">
                      <table className="w-full">
                        <thead>
                        <tr className="border-b border-gray-800/50">
                          <th className="text-left px-4 py-2 text-[11px] font-medium text-gray-600 uppercase tracking-wider">User</th>
                          <th className="text-left px-4 py-2 text-[11px] font-medium text-gray-600 uppercase tracking-wider hidden sm:table-cell">Role</th>
                          <th className="text-left px-4 py-2 text-[11px] font-medium text-gray-600 uppercase tracking-wider hidden md:table-cell">Deleted</th>
                        </tr>
                        </thead>
                        <tbody>
                        {deletedStaff.map((s) => (
                            <tr key={s.id} className="border-b border-gray-800/30">
                              <td className="px-4 py-2">
                                <div className="text-sm text-gray-500 line-through">{s.name || "—"}</div>
                                <div className="text-[11px] text-gray-600">{s.email}</div>
                              </td>
